...
public class BannerListAdapter  extends RecyclerView.Adapter<BannerListAdapter.SingleItemRowHolder> {
    ...
    private ArrayList<BannerData> itemsList;
    private Context mContext;
    private static MyClickListener myClickListener;
    private int position;

    public BannerListAdapter(Context context, ArrayList<BannerData> itemsList) {
    ...
    public void onBindViewHolder(SingleItemRowHolder holder, final int i) {
        ...
        Log.d(TAG, "onBindViewHolder: " +itemsList.get(i).getBanner_image() );
        Glide.with(mContext)
                .load(itemsList.get(i).getBanner_image())
    ...
    public void setOnItemClickListener(MyClickListener myClickListener) {
        BannerListAdapter.myClickListener = myClickListener;
    }
