...
public class MostPopularListAdapter extends RecyclerView.Adapter<MostPopularListAdapter.SingleItemRowHolder> {
    ...
    public MostPopularListAdapter(Context context, ArrayList<MostPopularData> itemsList) {
    ...
    public class SingleItemRowHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private TextView product_name, product_price, product_percentage, product_merchant_name;
    ...
    public void setOnItemClickListener(MyClickListener myClickListener) {
        MostPopularListAdapter.myClickListener = myClickListener;
    }
